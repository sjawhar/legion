...
missing`, and the profile was pinned back to 1.17.0 (LEGION-52). LEGION-54 (pi-envoy 1.20.1) moved the credential
...
## What the fixed hook does (pi-envoy 1.20.1, LEGION-54)
