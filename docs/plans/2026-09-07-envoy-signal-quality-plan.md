...
- Modify: `packages/envoy/AGENTS.md` (topic list), `packages/envoy/README.md` if it documents topics or summaries.
...
- [ ] **Step 4: Docs** — update the topic list and summary description in `packages/envoy/AGENTS.md`.
