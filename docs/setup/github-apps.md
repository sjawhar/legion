...
└── ops serve (port 13384) — legion-ops[bot] token
```
...
- Scrubbed `GITHUB_TOKEN`, `GH_HOST`, `HOME` (prevents ambient credential leakage)
...
# You should see: 'Role serves started: impl:13382, review:13383, ops:13384'
