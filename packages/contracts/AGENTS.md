...
- model-facing Dispatch tool specifications built over an injected Zod surface and `zodSchemaApi`
...
- Build Dispatch tool shapes through `zodSchemaApi(hostZod)` so option bags apply to the host's Zod.
