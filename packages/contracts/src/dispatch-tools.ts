        ...
        .array(
          z.object({
            ...
            with: z
              .string()
              .describe(
                "Replacement text for replace, parsed as inline markdown within the matched block; a marker of a different kind from the block's own is literal text, and one repeating the block's own marker is refused."
              )
              .optional(),
            occurrence: z
              .number({ int: true, min: 0 })
