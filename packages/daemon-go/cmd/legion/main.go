...
// secretsd read, then the boot's refusal of an operator pod colliding with Legion's own
// (daemon.CheckOperatorPod), and nothing else — no store, no team, no process.
