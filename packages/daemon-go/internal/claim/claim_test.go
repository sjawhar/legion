...
// The project word every token and the private tmux server carry is the shipped daemon's (config.ts
// legionProjectToken): the operator's `project` lowercased, with everything outside [a-z0-9]
