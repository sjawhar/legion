...
// `mainEnvironment`), with `LEGION_DAEMON_API=go` the one that selects that client. The installed
// plugin declares the number it was built against as `legion.goDaemonApiVersion` in its
