...
export const DISPATCH_ARGUMENTS = {
  ...
  thread:
    'Continue an existing thread: "<n>" (an open issue in the repo; a plain work issue is adopted as a thread) or "owner/name#<n>". When set, omit subject, urgency, repo, and parent.',
