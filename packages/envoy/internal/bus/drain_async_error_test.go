...
// outright, since nats.go keeps it in memory, and a disconnect longer than its inactive threshold
// lets the server delete it. Then the delete answers "consumer not found". The consumer is gone,
