...
func (s *server) routes() []apiRoute {
	routes := []apiRoute{
		...
		{http.MethodGet, "/api/v1/issues/{key}/artifacts/{slug}/text", authAny, "An issue document's canonical markdown, by slug or unambiguous filename.", s.getArtifactText},
		{http.MethodGet, "/api/v1/issues/{key}/artifacts/{slug}/blocks", authAny, "An issue document's blocks, by slug or unambiguous filename.", s.getArtifactBlocks},
		...
		{http.MethodPost, "/api/v1/issues/{key}/artifacts/{slug}/edits", authAny, "Apply edit ops to an issue document, by slug or unambiguous filename.", s.editArtifact},
		...
		{http.MethodGet, "/api/v1/projects/{key}/artifacts/{slug}/text", authAny, "A project document's canonical markdown, by slug or unambiguous filename.", s.getArtifactText},
		...
		{http.MethodGet, "/api/v1/projects/{key}/artifacts/{slug}/blocks", authAny, "A project document's blocks, by slug or unambiguous filename.", s.getArtifactBlocks},
		...
		{http.MethodPost, "/api/v1/projects/{key}/artifacts/{slug}/edits", authAny, "Apply edit ops to a project document, by slug or unambiguous filename.", s.editArtifact},
