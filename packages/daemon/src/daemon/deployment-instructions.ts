 ...
 * path — the copy every launched pane carries as the last part of its one `--append-system-prompt`
 * value, `$(cat <this file>)` (`processes.ts`), so panes get exactly what boot validated, never the
