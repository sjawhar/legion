...
describe("suggestAction", () => {
  ...
  it("needs_review_approved transitions to retro", () => {
    const action = suggestAction(IssueStatus.NEEDS_REVIEW, true, false, "approved", true, false);
  ...
  it("needs_review_worker_done_ignores_live_worker", () => {
    const action = suggestAction(IssueStatus.NEEDS_REVIEW, true, true, "approved", true, false);
    expect(action).toBe("transition_to_retro");
  });
