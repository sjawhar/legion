 ...
 * credential-helper chain and name the one-shot helper for https://github.com, LEGION-178, and
 * `GIT_CONFIG_GLOBAL`/`GIT_CONFIG_NOSYSTEM`); `JJ_USER`/`JJ_EMAIL` for the adoption —
