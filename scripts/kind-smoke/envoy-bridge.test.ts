...
import { bridgeConfigFromEnvironment, envelopeValidation } from "./envoy-bridge";
...
describe("bridgeConfigFromEnvironment", () => {
  ...
  test("requires SMOKE_RIG_NATS", () => {
    expect(() =>
      bridgeConfigFromEnvironment({ SMOKE_REPO: "a/b", SMOKE_UPSTREAM_NATS: "nats://y:1" })
